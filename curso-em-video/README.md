...
Curso intermediário, com foco no controle do fluxo do programa, 
repetição de tarefas e modularização do código, aprofundando a lógica
de programação e a escrita de programas mais estruturados.
